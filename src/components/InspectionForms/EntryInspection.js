...
import OrderEntryAutocomplete from "../OrderEntry/OrderEntryAutocomplete";
  ...
  const handleSubmit = () => {
    ...
    try {
      const res = axios.post(
        process.env.REACT_APP_BACKEND + "order/entry",
        { id, formdata },
        {
          headers: {
...
/>
          ...
          <Grid item sx={{ width: "100%", marginTop: "2px" }}>
            <Grid container sx={{ display: "flex", flexDirection: "row" }}>
              ...
              <Grid item xs={10} sx={{paddingTop : "12px"}}>
                <Typography
                  style={{
                    fontFamily: "Work Sans",
                    fontSize: "12px",
          ...
          <Grid item>
            ...
            >
              {reparing.map((data) => (
                <Grid
                  className="switches"
                  sx={{ margin: "3px", border: "0px 0px 1px 0px", width: '31%', }}
                >
                  <FormControlLabel
                    key={data.label}
                    control={
          ...
          >
            <Button
              startIcon={
                <CancelSharpIcon sx={{ margin: "0", fontSize: "13px" }} />
              }
              sx={{
                padding: "0",
                fontFamily: "Work Sans",
            ...
            >
              <SignatureCanvas
                ...
                canvasProps={{
                  height: 180,
                  width: width <= 335 ? 250 : width <= 405 ? 250 : 300,
                }}
            ...
            <Divider
              variant={"middle"}
              style={{ marginBottom: "15px", backgroundColor: "#000000" }}
            />
          </Grid>
