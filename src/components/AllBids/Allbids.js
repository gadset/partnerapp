...
export default function Allbids() {
    ...
    const getallbids = async () => {
      try {
        const response = await axios.get(
          process.env.REACT_APP_BACKEND + `users/getquotes`,
          {
            headers: {
  ...
  const handlebidsubmission = async (data) => {
    ...
    const { service, qualities } = data;
    // console.log({id,partnerid,amount,warranty,service})
    try {
      const resp = await axios.post(
        process.env.REACT_APP_BACKEND + "partner/submitquote",
        { id, partnerid, qualities, service },
        {
          headers: {
            // "x-token": cookies.token,
			'x-token' : localStorage.getItem("token"),
  ...
  return (
    ...
    >
      ...
      >
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Device<span style={{ float: "right" }}>:</span>
                </Grid>
                <Grid
                  item
                  sx={{
              ...
              >
                ...
                >
                  Model<span style={{ float: "right" }}>:</span>
                </Grid>
                <Grid
                  item
                  sx={{
              ...
              >
                ...
                >
                  Issue<span style={{ float: "right" }}>:</span>
                </Grid>
              ...
              >
                ...
                >
                  Quoted on<span style={{ float: "right" }}>:</span>
                </Grid>
                <Grid
                  item
                  sx={{
              ...
              >
                ...
                >
                  No of Active bids : {order.quotesbypartner.length}
                </Typography>

                <Button
                  onClick={() => {
                    handleOpenNewBid(order);
                  }}
                  sx={{
                    padding: "5px 10px 5px 10px",
        ...
        <Modal open={open} onClose={handleCloseNewBid}>
          <Grid
            sx={{
              padding: "0",
