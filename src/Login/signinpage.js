...
import Demo from "../components/getlocation.js";
import { useDispatch } from "react-redux";
import { setAddressValue, setallValue, setemailValue, setnameValue, setPartnerIdValue } from "../reduxslice.js";
...
if(isloggedin){
 ...
 toast.success("already logged in");
  ...
  const verifyOtp = async (e) => {
	...
	fetch(process.env.REACT_APP_BACKEND + `partner/checkpartner?phone=${number}`, {
                method: 'GET',
                headers: {
                  'Accept': 'application/json, text/plain, */*',
                  'Content-Type': 'application/json'
